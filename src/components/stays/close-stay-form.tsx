...
export const CloseStayForm = ({stayId,pays,room,stayComments}:Props) => {
  ...
  const handleOpen = () => {
    if(pays.length === 0) return  stSetStaticMsg('debes registrar un pago para terminar la estadia');
  ...
  return (
    <>
      <div className='w-full'>
        <button 
          className='ml-auto flex items-center gap-2 text-white bg-green-01 rounded-lg text-xl px-4 py-2 font-bold'
          onClick={handleOpen}
        >
          Terminar Estadia

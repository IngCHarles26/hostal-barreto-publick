...
import { ClientList } from '@/lib/index.interface'
...
export const NewStayForm = ({rooms}:Props) => {
  ...
  const originData = Object.keys(seedOrigins).toSorted( (a,b) => a.localeCompare(b))
          ...
          <div className='px-4 mt-5'>
            { clientList.map( client => (
              ...
              >
                ...
                <button 
                  className='ml-auto uppercase px-3 py-1 bg-orange-1 text-white rounded-xl'

...
export const TableHeader = ({ children }: Props) => {
  return (
    <div className="w-full bg-bg-sidebar flex gap-1 items-center text-done-button-text py-3 md:py-4 rounded-t-xl md:rounded-t-2xl px-3 md:px-4 font-extrabold text-base md:text-lg mb-2 uppercase sticky top-0 z-30">
      {children}
    </div>
  );
};
...
export const TableSeparator = () => {
  return <div className="w-full border-x h-1.5 border-bg-sidebar" />;
};
export const TableFooter = () => {
  return <div className="w-full border-x border-b rounded-b-lg h-1.5 border-bg-sidebar" />;
};

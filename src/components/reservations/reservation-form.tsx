...
import { TypeRoom } from '@/generated/prisma/browser'
                    ...
                    {rooms.map( el => 
                      <div key={'chheckbox_'+el}>
                        ...
                        <label 
                          ...
                          className=" inline-flex items-center justify-center px-3 py-1  rounded-md border border-none shadow cursor-pointer select-none transition-all duration-200 text-sm font-medium bg-white peer-checked:bg-details text-body peer-checked:text-white peer-checked:border-details peer-checked:shadow-inner hover:opacity-80">
                          {el}
                        </label>
                      </div>)
                    }

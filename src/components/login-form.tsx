...
export const LoginForm = () => {
  ...
  //       {
  //         email: "cahecova@gmail.com", // user email address
  //         password: "Prueba!123", // user password -> min 8 characters by default
  //         name: " Carlos", // user display name
  //       },
  //       {
  //         onRequest: (ctx) => {
  //           //show loading
    ...
    <>
      <form className="space-y-6 w-full " onSubmit={onSubmit}>
        <div className="flex flex-col gap-2">
          <label className="text-[#111418] text-sm font-bold px-1" htmlFor="email">
            Usuario
          </label>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center px-1">
            <label className="text-[#111418] text-sm font-bold" htmlFor="password">
              Contraseña
            </label>
          </div>
          <div className="relative group">
      ...
      <div className="mt-12 flex flex-col items-center  md:gap-1">
        ...
        <div className="flex items-center gap-6 text-sm font-bold text-[#617589] mt-8">
          <a
            className="hover:text-primary transition-colors underline decoration-2 underline-offset-4 decoration-primary/20"
            target="_blank"
            href="#">

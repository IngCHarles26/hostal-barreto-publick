...
import { FaCalendarAlt, FaDoorOpen, FaPlus } from "react-icons/fa"
...
export const NewActive = ( {rooms}:Props ) => {
  ...
  const handleCLick = async () => {
    ...
    const dateCreate = newRoomActive.born
    ...
    const success = await SAcreateRoomActive(newDescription,newRoom,new Date(dateCreate))
